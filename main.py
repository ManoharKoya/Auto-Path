...
net.load(weights_filename='old_weights_biases/generation_7_weights.npy', biases_filename='old_weights_biases/generation_7_bises.npy')
game.start(display=True, neural_net=net)
...
"""
# gen = genetic_Algorithm(population_size=1000, crossover_method='neuron', mutation_method='weight')
# gen = genetic_Algorithm(populationSize=1000, crossoverType="Neuron_change", mutationType="Weight_change")
